  ...
  return (
    ...
    >
      ...
      <div className="w-full flex-1 flex flex-col items-center justify-center z-10 px-4 min-h-0">
        <div className="relative w-full max-w-[950px] aspect-video max-h-[60vh] bg-black rounded-[2rem] border-[6px] md:border-[8px] border-orange-400 shadow-[0_10px_0_#ea580c] overflow-hidden group mb-4 md:mb-6">
            <video
                ref={videoRef}
                src={mainVideo}
