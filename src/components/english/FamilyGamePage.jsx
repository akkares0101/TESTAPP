...
function FamilyGamePage({ onVideoStateChange }) {
  ...
  useEffect(() => {
    ...
    // ⭐ 3. คืนค่าเพลงพื้นหลังให้กลับมาเล่นปกติ เมื่อออกจากหน้านี้
    return () => {
      if (onVideoStateChange) {
      ...
      <div className="flex-1 w-full flex items-center justify-center px-4 overflow-hidden">
        <div className="relative w-full max-w-7xl aspect-video max-h-[75vh] shadow-2xl rounded-2xl border-4 border-white overflow-hidden bg-black">
          <iframe
            ...
            src="https://storage.googleapis.com/mtr-system/media-app/public/game/english/english-trace/index.html"
