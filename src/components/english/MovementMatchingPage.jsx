      ...
      {isGameOver && (
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/60 backdrop-blur-sm p-4 animate-fade-in">
           <div className="bg-white rounded-[3rem] p-8 md:p-12 max-w-lg w-full text-center border-[8px] border-yellow-400 shadow-[0_20px_60px_rgba(0,0,0,0.5)] relative overflow-hidden animate-bounce-in">
              ...
              <p className="text-gray-500 font-bold text-xl mb-6 relative z-10">เก่งมากเลย!</p>

              {/* ดาวดึ๋งๆ */}
              <div className="flex justify-center gap-2 mb-8 relative z-10">
                 {[1, 2, 3].map((star, i) => (
                    <span key={i} className="text-6xl md:text-8xl drop-shadow-lg animate-star-pop" style={{animationDelay: `${i*0.2}s`}}>⭐</span>
                 ))}
              </div>
