...
function AlphabetGamePage({ isMuted }) {
  ...
  // สี Background สุ่ม
  const bgColors = [
    'bg-rose-500', 'bg-sky-500', 'bg-green-500', 'bg-yellow-400', 
  ...
  return (
    <div 
      ...
      style={{ backgroundImage: `url(${bgImage})`, backgroundSize: '100% 100%', backgroundPosition: 'center', backgroundAttachment: 'fixed' }}
    >
      {/* Header */}
