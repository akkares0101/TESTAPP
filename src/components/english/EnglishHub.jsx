...
function EnglishHub({ navigate, playClick }) {
 ...
 const menuItems = [
    ...
    { id: 1, image: btnABC, path: "/alphabet/select", title: "Alphabet" }, // (แนะนำ) ถ้าจะเข้าไปเรียน ABC ให้ชี้ไปหน้าเลือก
    { id: 2, image: btnFamily, path: "/eng-letters", title: "Family" },
    
    // ⭐ แก้บรรทัดนี้ครับ: เปลี่ยน path ให้ตรงกับ Route เกมใหม่
