...
// ⭐ Import รูปปุ่ม 5 ปุ่ม (แก้ชื่อไฟล์ให้ตรงกับรูปที่คุณมีนะครับ)
import btnConsonant from '../../assets/images/thai/btn_consonant.png'; // พยัญชนะไทย
import btnTone from '../../assets/images/thai/btn_tone.png';           // วรรณยุกต์
import btnVowel from '../../assets/images/thai/btn_vowel.png';         // สระ
import btnGame from '../../assets/images/thai/btn_game_write.png';     // เกม
import btnHandwriting from '../../assets/images/thai/btn_handwriting.png'; // คัดลายมือ
...
function ThaiWritingMenuPage({ isMuted }) {
  ...
  // รายการเมนู 5 ปุ่ม ตามที่ขอมาครับ
  const menuItems = [
    { id: 1, image: btnConsonant, path: "/thai-alphabet/write-consonant", title: "พยัญชนะไทย" },
    { id: 2, image: btnTone, path: "/thai-alphabet/write-tone", title: "วรรณยุกต์ในภาษาไทย" },
    { id: 3, image: btnVowel, path: "/thai-alphabet/write-vowel", title: "สระในภาษาไทย" },
    { id: 4, image: btnGame, path: "/thai-alphabet/write-game", title: "เกม" },
    { id: 5, image: btnHandwriting, path: "/thai-alphabet/handwriting", title: "คัดลายมือ" },
  ];

  // จัดเรียง: แถวบน 3 ปุ่ม / แถวล่าง 2 ปุ่ม
  ...
  const renderButton = (item) => (
    <div
      ...
      className="
        ...
        /* ⭐ ขนาดปุ่มใหญ่สะใจ (ตามสไตล์หน้าหลัก) */
        w-[160px] h-[160px] 
