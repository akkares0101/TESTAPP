...
function SocialRoutinesPage({ isMuted, onVideoStateChange }) {
  ...
  return (
    ...
    >
      ...
      {/* 1. ส่วนหัว (❌ ไม่มีปุ่มกลับ โทนสี Amber) */}
      ...
      <div className="w-full flex-1 flex flex-col items-center justify-center z-10 px-4 min-h-0">
        <div className="relative w-full max-w-[950px] aspect-video max-h-[70vh] bg-black rounded-[2rem] border-[6px] md:border-[8px] border-amber-400 shadow-[0_10px_0_#f59e0b] overflow-hidden group mb-4 md:mb-6">
            <video
                ref={videoRef}
                src={mainVideo}
