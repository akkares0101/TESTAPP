...
function SocialDressingPage({ isMuted, onVideoStateChange }) {
  ...
  // 👗 Path วิดีโอหลัก
  // ⚠️ เตรียมไฟล์วิดีโอไว้ที่: public/videos/social/การแต่งกาย.mp4
  const mainVideo = "/videos/social/การแต่งกาย.mp4";
  ...
  return (
    ...
    >
      ...
      <div className="w-full max-w-6xl px-4 flex-1 min-h-0 flex flex-col items-center justify-center z-10 pb-10">
        <div className="relative w-full aspect-video bg-black rounded-[2rem] border-[8px] border-blue-400 shadow-[0_15px_0_#3b82f6] overflow-hidden group transition-transform duration-300 hover:scale-[1.01]">
            <video
                ref={videoRef}
                src={mainVideo}
