...
function AseanNationalFlowersPage({ isMuted, onVideoStateChange }) {
  const videoRef = useRef(null);
  const [selectedCountry, setSelectedCountry] = useState(null);
  const [isPlaying, setIsPlaying] = useState(true);

  // 🎥 Path วิดีโอหลัก
  const mainVideo = "https://storage.googleapis.com/mtr-system/media-app/public/videos/asean/flowers.mp4";
  ...
  // 🌸 ข้อมูลประเทศและเวลา
  const aseanData = [
    { id: "brunei", name: "บรูไน", time: 16 },
    { id: "cam", name: "กัมพูชา", time: 37 },
    { id: "indo", name: "อินโดนีเซีย", time: 61 },
    { id: "laos", name: "ลาว", time: 86 },
    { id: "malay", name: "มาเลเซีย", time: 109 },
    { id: "myan", name: "เมียนมา", time: 125 },
    { id: "phil", name: "ฟิลิปปินส์", time: 148 },
    { id: "sing", name: "สิงคโปร์", time: 166 },
    { id: "thai", name: "ไทย", time: 191 },
    { id: "viet", name: "เวียดนาม", time: 210 },
    { id: "timor", name: "ติมอร์", time: 231 }
  ];
    ...
    <div className="h-screen w-full overflow-hidden flex flex-col items-center relative">
      ...
      <div className="w-full max-w-[1150px] shrink-0 bg-white/90 backdrop-blur-md rounded-t-[2.5rem] border-t-2 border-white shadow-[0_-10px_30px_rgba(0,0,0,0.1)] flex flex-col items-center z-20 pt-2 pb-5">
        ...
        <div className="flex items-center gap-4 mb-3 shrink-0">
            ...
            <span className="text-orange-500 font-bold text-xs uppercase tracking-widest hidden md:block">Select Flower</span>
        </div>
...
export default AseanNationalFlowersPage;