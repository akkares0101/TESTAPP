...
function AseanGreetingsPage({ isMuted, onVideoStateChange }) {
  ...
  // 🎥 Path วิดีโอหลัก
  const mainVideo = "https://storage.googleapis.com/mtr-system/media-app/public/videos/asean/greetings.mp4";
  ...
  // 🙏 ข้อมูลประเทศและเวลา
  const aseanData = [
    { id: "brunei", name: "บรูไน", time: 14 },
    { id: "cam", name: "กัมพูชา", time: 41 },
    { id: "indo", name: "อินโดนีเซีย", time: 58 },
    { id: "laos", name: "ลาว", time: 80 },
    { id: "malay", name: "มาเลเซีย", time: 102 },
    { id: "myan", name: "เมียนมา", time: 120 },
    { id: "phil", name: "ฟิลิปปินส์", time: 143 },
    { id: "sing", name: "สิงคโปร์", time: 164 },
    { id: "thai", name: "ไทย", time: 187 },
    { id: "viet", name: "เวียดนาม", time: 209 },
    { id: "timor", name: "ติมอร์", time: 229 }
  ];
