...
function AseanNationalCostumesPage({ isMuted, onVideoStateChange }) {
  ...
  // 🎥 Path วิดีโอหลัก
  const mainVideo = "https://storage.googleapis.com/mtr-system/media-app/public/videos/asean/costumes.mp4";
  ...
  const aseanData = [
    ...
    { id: "cam", name: "กัมพูชา", time: 45 },
    { id: "indo", name: "อินโดนีเซีย", time: 62 },
    { id: "laos", name: "ลาว", time: 88 },
    { id: "malay", name: "มาเลเซีย", time: 111 },
    { id: "myan", name: "เมียนมา", time: 139 },
    { id: "phil", name: "ฟิลิปปินส์", time: 156 },
    { id: "sing", name: "สิงคโปร์", time: 184 },
    { id: "thai", name: "ไทย", time: 215 },
    { id: "viet", name: "เวียดนาม", time: 242 },
    { id: "timor", name: "ติมอร์", time: 259 }
  ];
